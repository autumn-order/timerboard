...
pub struct FleetNotificationBuilder {
    /// Discord HTTP client for fetching member information
    pub http: Arc<Http>,
}

impl FleetNotificationBuilder {
    /// Creates a new FleetNotificationBuilder instance.
    ///
    /// # Arguments
    ...
    ///
    /// # Returns
    /// - `FleetNotificationBuilder` - New builder instance
